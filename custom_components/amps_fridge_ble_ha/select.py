...
async def async_setup_entry(
    ...
    async_add_entities([AmpsFridgeBatterySaverSelect(entry, entry.runtime_data.api)])
...
class AmpsFridgeBatterySaverSelect(AmpsFridgeEntity, SelectEntity):
    ...
    def current_option(self) -> str | None:
        ...
        return BATTERY_SAVER_MAP_REV.get(self.api.status.get("bat_saver"))
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        await self.api.async_set_values({"bat_saver": BATTERY_SAVER_MAP[option]})
